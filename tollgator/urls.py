...
urlpatterns = [
    ...
    path('register/student', user_views.StudentRegisterView.as_view(), name='student-register'),
    path('register/instructor', user_views.InstructorRegisterView.as_view(), name='instructor-register'),
